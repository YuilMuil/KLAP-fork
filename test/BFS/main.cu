        ...
        switch(opt) {
            ...
            default : std::cerr <<
                      "\nUsage:  ./bfs [options]"
                          ...
                          "\n    -g <G>    metis graph file name or \"random\" if generating a random graph (default=random)"
                          "\n    -v <V>    # of vertices if generating a random graph (default=10000)"
                          "\n    -d <D>    average node degree if generating a random graph (default=1000)"
                          "\n    -h        help\n\n";
                      exit(0);
        }
    }
